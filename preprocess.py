...
# CUDA_VISIBLE_DEVICES=0 HF_ENDPOINT='https://hf-mirror.com' python preprocess.py
...
class Preprocess(nn.Module):
    ...
    def extract_latents(self,
        ...
        rgb = self.decode_latents(latent_frames)
        return rgb
...
if __name__ == "__main__":
    ...
    n_frames = save_video_frames(video_path, img_size=(opt.W, opt.H))
    if opt.n_frames == 'all':
        opt.n_frames = n_frames
    else:
        opt.n_frames = int(opt.n_frames)
